...
A \Src{Sunroof $\alpha$} constraint would be to restrictive,
...
the \Src{apply} or \Src{\$\$} combinator.
...
\Src{JSContinuation $\alpha$} is used models continuations in the \JS-monad. 

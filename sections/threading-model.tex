...
abstractions for synchronization, e.g. \Src{MVar}s (TODO: Cite MVar/Chan paper).
...
There a three main primitives Sunroof offers to work with in
the blocking model.
\begin{verbatim}
forkJS      :: (...) => JS t1 () -> JS t2 ()
...
We depend on the JavaScript function \Src{window.setTimeout} to be provided

...
Since observable sharing \TODO{Cite?} is used to optimize compilation
of expressions, the actual expressions type is a bit more 
complicated and involves a fixpoint \TODO{Cite?}.} 
...
The \Src{{\linebreak}SunroofArgument} prerequisite is there, because 
every Sunroof value can be argument of a function 
...
\Src{ValueOf} \cite{Chakravarty:05:AssociatedTypeSynonyms} and offers the function 

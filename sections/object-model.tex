...
JavaScript expressions. Simplified slightly, we have:
\begin{Code}
data Expr 
...
to facilitate the usage observable sharing\cite{...},
and therefore sub-expression computations to also be shared.

Each of these wrappers implements the \Src{Sunroof} type 
class.
\begin{Code}
...
An example of is \Src{JSString}, the representation
...
manner. Some type in JavaScript are referential 

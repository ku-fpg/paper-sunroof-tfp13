...
\section{Sunroof Values} % TODO: rename
...
a common trick -- we can write a clean Haskell function that can still be reify:
\begin{Code}
f  x = x + 1
\end{Code}
...
argument, like \Src{(Var "x")} above. 

\paragraph{Monadic Reification:}

\paragraph{Optional CPS translation:}

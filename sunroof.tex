...
We close with a related work and our conclusions.
All the ideas used here are not new, though the use of monadic reification
for JavaScript generation is original. What we demonstrate is how
far the practical aspects of DSL capture has come, using the full scale example
